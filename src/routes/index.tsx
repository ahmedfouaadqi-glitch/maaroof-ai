        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Step
              ...
              desc="بعد الاشتراك: تختار موقعك أو موضوعك من قائمة، وتكتب أوامر مثل (حلّل صفحتي / اقترح منشور ترويجي / راقب GEO أسبوعياً). الوكيل ينفّذ تلقائياً بدون دردشة. مثال: تضيف رابط متجرك → يرسل لك تقرير يومي + 3 اقتراحات منشورات جاهزة للنشر."
            />
          </div>
        </div>
      </section>
