...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "MAAROOF Ai — GEO - SEO - AEO , Cited by ChatGPT & Gemini" },
      { name: "twitter:description", content: "MAAROOF Ai is the Generative Engine Optimization platform & SEO, AEO & MENA. Score, optimize and publish content so 9 AI engines cite your brand in EN, AR & KU." },
