...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Generative Engine Optimization for Iraq. Part Of A Marouf Intellige,Test, score and optimize your content so ChatGPT, Gemini and Claude cite you  in EN, AR, KU." },
      { name: "author", content: "Marouf Intelligence" },
      { property: "og:title", content: "GEO-Iraq · Become the Source AI Trusts" },
      { property: "og:description", content: "Generative Engine Optimization for Iraq. Part Of A Marouf Intellige,Test, score and optimize your content so ChatGPT, Gemini and Claude cite you  in EN, AR, KU." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Space+Grotesk:wght@500;600;700&family=Noto+Kufi+Arabic:wght@400;500;600;700&family=Vazirmatn:wght@400;500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
