...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MAAROOF Ai — GEO for Iraq, Cited by ChatGPT & Gemini" },
      { property: "og:description", content: "MAAROOF Ai is the Generative Engine Optimization platform for Iraq & MENA. Score, optimize and publish content so 9 AI engines cite your brand in EN, AR & KU." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MAAROOF Ai — GEO for Iraq, Cited by ChatGPT & Gemini" },
      { name: "twitter:description", content: "MAAROOF Ai is the Generative Engine Optimization platform for Iraq & MENA. Score, optimize and publish content so 9 AI engines cite your brand in EN, AR & KU." },
