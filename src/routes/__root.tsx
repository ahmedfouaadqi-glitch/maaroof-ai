...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Generative Engine Optimization for Iraq. Test, score and optimize your content so ChatGPT, Gemini and Claude cite you in EN, AR, KU." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "MAAROOF Ai · Become the Source AI Trusts" },
