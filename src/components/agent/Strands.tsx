// Strands — React Bits WebGL ribbon (ogl). Used as the agent activity pulse.
...
export type StrandsProps = {
  ...
  dispersion?: number;
  glassSize?: number;
  /** When false, the render loop is fully stopped (idle state). */
  animate?: boolean;
  className?: string;
  style?: CSSProperties;
};
...
export default function Strands({
  ...
  propsRef.current = {
    ...
    hueShift, intensity, saturation, opacity, scale, glass, refraction, dispersion,
    glassSize, animate,
  };
