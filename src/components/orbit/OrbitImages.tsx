...
// Adapted to TypeScript and extended with an optional `items` prop so React
// nodes (e.g. inline SVG brand marks) can orbit instead of raster images.
import {
  useMemo,
  useEffect,
  useLayoutEffect,
...
export type OrbitImagesProps = {
  images?: string[];
  /** React nodes to orbit; takes precedence over `images`. */
  items?: ReactNode[];
  altPrefix?: string;
  shape?: OrbitShape;
  customPath?: string;
